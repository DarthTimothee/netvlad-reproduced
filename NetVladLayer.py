...
class NetVladLayer(nn.Module):
    ...
    def __init__(self, w, b, K):
        # TODO: where to get amount of kernels? hyper parameter?
        ...
        self.conv = nn.Conv2d(in_channels=256, out_channels=K, kernel_size=(w, b))
        self.vlad_core = VladCore(K)
        self.intra_normalization = nn.Identity()   # TODO: normalization
        self.L2 = nn.Identity()  # TODO: normalization
