...
from NetVLAD import AlexBase, FullNetwork, L2Norm, NetVLAD, VGG16Base
...
# Hacky data path:
DATA_PATH = 'data' if cuda.is_available() else 'G:/School/Deep Learning/data/'
...
# pooling_layer = nn.Identity()  # no pooling
